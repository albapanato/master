...
/ El cliente busca algo en internet <c>=></c> el navegador manada la solicitud a <c>=></c> DNS que lo traduce la busqueda a una dirrección IP / <br>
/ Cuando encuentra la busqueda <c>=></c> DNS vuelve a traducir la informacion encontrada <c>=></c>para luego mostrarla como pagina web /<br><br>
